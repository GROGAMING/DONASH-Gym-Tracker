...
-- Replace <YOUR_TEAM_ID> below with the value of your TEAM_ID
-- env variable, then run this block in the Supabase SQL editor.
-- ============================================================
-- Example: if TEAM_ID=abc-123-def then replace every occurrence
-- of <YOUR_TEAM_ID> with abc-123-def
